<div class="limiter">
    ...
    <form class="form" method="post" action="<?php echo site_url('PegawaiController/edit/').$record['id_pegawai']?>">
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Nama tidak boleh kosong">
                        <input class="input100" type="text" name="nama" placeholder="Nama" required value="<?php echo $record['nama']?>">
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Nip tidak boleh kosong">
                        <input class="input100" type="number" name="nip" placeholder="Nip" required value="<?php echo $record['nip']?>">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Pangkat tidak boleh kosong">
                        <input class="input100" type="text" required value="<?php echo $record['pangkat']?>" name="pangkat" placeholder="Pangkat">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Tmt Pangkat tidak boleh kosong">
                        <input class="input100" type="text" name="tmtpangkat" id="datepicker" required value="<?php echo $record['tmtpangkat']?>" placeholder="TMT Pangkat">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Jabatan tidak boleh kosong">
                        <input class="input100" type="text" name="jabatan" placeholder="Jabatan" required value="<?php echo $record['jabatan']?>">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Tmt Jabatan tidak boleh kosong">
                        <input class="input100" type="text" name="tmtjabatan" id="datepicker1" placeholder="Tmt Jabatan" required value="<?php echo $record['tmtjabatan']?>">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Nama diklat tidak boleh kosong">
                        <input class="input100" type="text" name="namadiklat" placeholder="Nama Diklat" required value="<?php echo $record['namadiklat']?>">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Tahun tidak boleh kosong">
                        <input class="input100" type="number" name="tahundiklat" placeholder="Tahun Diklat" required value="<?php echo $record['tahundiklat']?>">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Pendidikan tidak boleh kosong">
                        <input class="input100" type="text" name="pendidikan" placeholder="Pendidikan" required value="<?php echo $record['pendidikan']?>">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
            ...
            <tr>
                ...
                <td>
                    <div class="wrap-input100 validate-input" data-validate = "Tanggal Lahir tidak boleh kosong">
                        <input class="input100" type="text" required value="<?php echo $record['tgl_lahir']?>" name="tgl_lahir" id="datepicker2" placeholder="Tanggal Lahir">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
